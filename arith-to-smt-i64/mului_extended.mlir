...
"builtin.module"() ({
  "func.func"() ({
  ^0(%x : i64, %y : i64):
    %low, %high = arith.mului_extended %x, %y : i64
    func.return %low, %high : i64, i64
  }) {"sym_name" = "test", "function_type" = (i64, i64) -> (i64, i64), "sym_visibility" = "private"} : () -> ()
}) : () -> ()
...
// CHECK-NEXT:      %7 = "smt.bv.zero_extend"(%2) : (!smt.bv.bv<32>) -> !smt.bv.bv<64>
// CHECK-NEXT:      %8 = "smt.bv.zero_extend"(%4) : (!smt.bv.bv<32>) -> !smt.bv.bv<64>
