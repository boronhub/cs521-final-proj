...
"builtin.module"() ({
  ...
  ^0(%x : i64):
    "func.return"(%x) : (i64) -> ()
  }) {"sym_name" = "test", "function_type" = (i64) -> i64, "sym_visibility" = "private"} : () -> ()
}) : () -> ()
...
// CHECK-NEXT:    }) {"fun_name" = "test"} : () -> ((!smt.utils.pair<!smt.bv.bv<32>, !smt.bool>, !effect.state) -> (!smt.utils.pair<!smt.bv.bv<32>, !smt.bool>, !effect.state))
// CHECK-NEXT:  }
