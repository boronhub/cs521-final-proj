...
"builtin.module"() ({
  "func.func"() ({
  ^0(%x : i64, %y : i64):
    %r = "arith.shli"(%x, %y) : (i64, i64) -> i64
    "func.return"(%r) : (i64) -> ()
  }) {"sym_name" = "test", "function_type" = (i64, i64) -> i64, "sym_visibility" = "private"} : () -> ()
}) : () -> ()
...
// CHECK-NEXT:      %7 = "smt.bv.shl"(%2, %4) : (!smt.bv.bv<32>, !smt.bv.bv<32>) -> !smt.bv.bv<32>
// CHECK-NEXT:      %8 = "smt.bv.constant"() {"value" = #smt.bv.bv_val<32: 32>} : () -> !smt.bv.bv<32>
// CHECK-NEXT:      %9 = "smt.bv.ugt"(%4, %8) : (!smt.bv.bv<32>, !smt.bv.bv<32>) -> !smt.bool
// CHECK-NEXT:      %10 = "smt.or"(%9, %6) : (!smt.bool, !smt.bool) -> !smt.bool
// CHECK-NEXT:      %r = "smt.utils.pair"(%7, %10) : (!smt.bv.bv<32>, !smt.bool) -> !smt.utils.pair<!smt.bv.bv<32>, !smt.bool>
