...
"builtin.module"() ({
  "func.func"() ({
    ...
    %1 = "arith.constant"() <{value = 27 : i64}> : () -> i64
    %r = "arith.muli"(%0, %1) : (i64, i64) -> i64
    "func.return"(%r) : (i64) -> ()
  }) {"sym_name" = "test", "function_type" = () -> i64, "sym_visibility" = "private"} : () -> ()
}) : () -> ()
...
// CHECK-NEXT:      %7 = "smt.bv.mul"(%2, %4) : (!smt.bv.bv<32>, !smt.bv.bv<32>) -> !smt.bv.bv<32>
// CHECK-NEXT:      %r = "smt.utils.pair"(%7, %6) : (!smt.bv.bv<32>, !smt.bool) -> !smt.utils.pair<!smt.bv.bv<32>, !smt.bool>
